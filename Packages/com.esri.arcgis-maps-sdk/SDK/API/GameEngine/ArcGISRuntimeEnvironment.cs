...
namespace Esri.GameEngine
{
    ...
    public partial class ArcGISRuntimeEnvironment
    {
        ...
        /// custom role that has the `Generate API keys` privilege. To learn how to create and manage API keys, go to the
        /// <see cref="Create an API Key">https://developers.arcgis.com/documentation/security-and-authentication/api-key-authentication/tutorials/create-an-api-key/</see>
        ...
        /// referrer, use the SDK's functionality to intercept the request and add an HTTP referer header.
        /// 
        ...
        /// <see cref="GameEngine.ArcGISRuntimeEnvironment.APIKey">ArcGISRuntimeEnvironment.APIKey</see> and enables more granular usage telemetry and management of the ArcGIS
        ...
        /// * <see cref="">BasemapStylesService</see>
        ...
        /// <see cref="API key authentication">https://developers.arcgis.com/documentation/security-and-authentication/api-key-authentication/</see> and
        /// <see cref="Types of authentication">https://developers.arcgis.com/documentation/security-and-authentication/types-of-authentication/</see>.
        /// </remarks>
        /// <since>1.0.0</since>
